...
micek1 = Micek([x, y], [rychlost_x, rychlost_y], 100, 1, CERVENA)
micek2 = Micek([200, 500], [-2, 3], 50, 4, MODRA)
micek3 = Micek([400, 400], [5, -3], 25, 10, ZELENA)
micek4 = Micek([400, 400], [9, -5], 200, 10, MODRA)

micky = (micek1, micek2, micek3, micek4)
for micek in micky:
    micek.vykreli()
